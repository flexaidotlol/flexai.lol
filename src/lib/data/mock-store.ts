...
export const INITIAL_CATEGORIES: Category[] = [
  ...
  { id: 'c4', slug: 'ai-code-dev', name: 'AI Code & Dev', description: 'Code generation, autocomplete, debuggers, and developer agents', icon: 'Code', sort_order: 4, is_active: true, total_bid_cents: 0, product_count: 0 },
  ...
  { id: 'c9', slug: 'ai-automation', name: 'AI Automation', description: 'No-code workflow pipelines, browser agents, and web scrapers', icon: 'RefreshCw', sort_order: 9, is_active: true, total_bid_cents: 100, product_count: 1 },
...
export const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    slug: 'buildfast',
    name: 'Buildfast',
    tagline: 'Ship production-ready AI automations at lightspeed.',
    description: 'Buildfast is the developer platform to prototype, build, and deploy full-stack AI automation workflows in minutes.',
